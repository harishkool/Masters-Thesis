...
class Model:
    ...
    def create_encoder(self, inputs):
        with tf.variable_scope('encoder_0', reuse=tf.AUTO_REUSE):
            ...
            # features.set_shape([NonNone, 1024])
        return features

    def create_decoder(self, features):
        print('features shape is {}'.format(features.get_shape()))
    ...
    def create_loss(self, coarse, coarse_fine, fine, gt, alpha, beta):
        ...
        gt_ds2 = gt[:, :coarse_fine.shape[1], :]
        loss_coarsefine = earth_mover(coarse_fine, gt_ds2)
