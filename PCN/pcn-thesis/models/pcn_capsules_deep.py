...
class Model:
    ...
    def caps_arch(self, inputs):
        # inputs is bn x 2048 x 3
        # adj matrix shape is bn x 2048 x 2048
        # nn shape is bn x 2048 x 10
        # construct dynamic routing between 10 
        # output cap dim is 64
        # 10 --> out dim 
