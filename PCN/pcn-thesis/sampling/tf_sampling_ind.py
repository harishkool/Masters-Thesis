...
def generate_samples(pcd_dir, save_dir):
    ...
    # cat = ["chair","car","airplane","table","watercraft","cabinet","sofa"]
    cat = ["sofa"]
    for dir in cat: 
...
if __name__=='__main__':
    generate_samples('/shared/kgcoe-research/mil/harish/pcn_data/pcd_datav2/valid', '/shared/kgcoe-research/mil/harish/pcn_data/pcd_datav2/valid/sampled_data')
