...
def pairwise_distance(point_cloud):
  ...
  # if len(pc_shape)==2:
    # point_cloud = tf.expand_dims(point_cloud, 0)
  # print(og_batch_size, og2, og3)
  # print('pc shape is {}:'.format(point_cloud.get_shape()))
...
def get_edge_feature(point_cloud, num_feat, var, nn_idx, k=20):
  ...
  """
  # print('Neighbhors shape is : '+str(nn_idx.get_shape()))
  og_batch_size = point_cloud.get_shape().as_list()[0]
  point_cloud = tf.squeeze(point_cloud)
  if og_batch_size == 1:
    point_cloud = tf.expand_dims(point_cloud, 0)
  # print('pc shape is in edge {}:'.format(point_cloud.get_shape()))
  ...
  idx_ = tf.multiply(tf.range(1), var)
